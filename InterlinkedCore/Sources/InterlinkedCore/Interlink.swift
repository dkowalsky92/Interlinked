...
public class Interlink {
    ...
    public init(configuration: Configuration) {
        ...
        let initializerFilterers: [InitializerFilterer] = [
            ViewControllerCoderInitializerFilterer(),
            DecodableInitializerFilterer(),
            ConvenienceInitializerFilterer()
        ]
        ...
        self.dependencySyntaxRewriter = DependencyRewriter(
            ...
            initializerFilterers: initializerFilterers,
            scopeBuilder: scopeBuilder
        )

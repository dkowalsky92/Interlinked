...
final class SyncSpec: XCTestCase {
    ...
    func testMiscellaneous() {
        let testCases: [TestCase] = [
            .init(
                context: "has matching variable and assignment, but incorrect type",
                input: """
                struct Test {
                    let value: String
            ...
            .init(
                ...
                class Test {
                    ...
                    init(value1: String, value2: String) {
                        let computedDescription = "\\(value1) \\(value2)"
                        self.computedDescription = computedDescription
                    }
                }
                """,
                expectedOutput: """
    ...
    func testAirbnbParameterFormatter() {
        let testCases: [TestCase] = [
            .init(
                context: "has airbnb formatter with single struct",
                configuration: .init(maxLineLength: 25, formatterStyle: .airbnb),
                input: """
                struct Test {
                    let value1: String
                    let value2: String
            ...
            .init(
                context: "has airbnb formatter with nested struct",
                configuration: .init(maxLineLength: 25, formatterStyle: .airbnb),
                input: """
                struct Test {
                    struct Model {
    ...
    func testLinkedinParameterFormatter() {
        let testCases: [TestCase] = [
            .init(
                context: "has linkedin formatter with single struct",
                configuration: .init(maxLineLength: 25, formatterStyle: .linkedin),
                input: """
                struct Test {
                    let value1: String
                    let value2: String
            ...
            .init(
                context: "has linkedin formatter with nested struct",
                configuration: .init(maxLineLength: 25, formatterStyle: .linkedin),
                input: """
                struct Test {
                    struct Model {
